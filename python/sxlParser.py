...
class sxlParser ( Parser ):
    ...
    def register(self):
        ...
        try:
            ...
            while True:
                ...
                self._errHandler.sync(self)
                _la = self._input.LA(1)
                if not ((((_la) & ~0x3f) == 0 and ((1 << _la) & ((1 << sxlParser.T__5) | (1 << sxlParser.T__7) | (1 << sxlParser.T__8) | (1 << sxlParser.T__11))) != 0)):
                    break
    ...
    def register_item(self):
        ...
        self.enterRule(localctx, 14, self.RULE_register_item)
        try:
            self.state = 123
            self._errHandler.sync(self)
            token = self._input.LA(1)
    ...
    def signals(self):
        ...
        self.enterRule(localctx, 16, self.RULE_signals)
        self._la = 0 # Token type
        try:
            self.enterOuterAlt(localctx, 1)
            self.state = 125
    ...
    def signal(self):
        ...
        self.enterRule(localctx, 18, self.RULE_signal)
        self._la = 0 # Token type
        try:
            self.enterOuterAlt(localctx, 1)
            self.state = 134
            ...
            while True:
                ...
                self._errHandler.sync(self)
                _la = self._input.LA(1)
                if not ((((_la) & ~0x3f) == 0 and ((1 << _la) & ((1 << sxlParser.T__6) | (1 << sxlParser.T__7) | (1 << sxlParser.T__15) | (1 << sxlParser.T__18) | (1 << sxlParser.T__29) | (1 << sxlParser.T__30) | (1 << sxlParser.T__31) | (1 << sxlParser.T__34) | (1 << sxlParser.T__35))) != 0)):
                    break
    ...
    def signal_item(self):
        ...
        self.enterRule(localctx, 20, self.RULE_signal_item)
        try:
            self.state = 152
            self._errHandler.sync(self)
            token = self._input.LA(1)
            if token in [sxlParser.T__15]:
                localctx = sxlParser.DontcareContext(self, localctx)
                self.enterOuterAlt(localctx, 1)
                self.state = 143
                self.unit()
                pass
            elif token in [sxlParser.T__18]:
                localctx = sxlParser.DontcareContext(self, localctx)
                self.enterOuterAlt(localctx, 2)
                self.state = 144
                self.numrep()
    ...
    def enumeration(self):
        ...
        self.enterRule(localctx, 22, self.RULE_enumeration)
        self._la = 0 # Token type
        try:
            self.enterOuterAlt(localctx, 1)
            self.state = 154
    ...
    def enum_item(self):
        ...
        self.enterRule(localctx, 24, self.RULE_enum_item)
        self._la = 0 # Token type
        try:
            self.enterOuterAlt(localctx, 1)
            self.state = 163
    ...
    def address(self):
        ...
        self.enterRule(localctx, 28, self.RULE_address)
        try:
            self.enterOuterAlt(localctx, 1)
            self.state = 174
    ...
    def size(self):
        ...
        self.enterRule(localctx, 30, self.RULE_size)
        try:
            self.enterOuterAlt(localctx, 1)
            self.state = 177
    ...
    def notify(self):
        ...
        self.enterRule(localctx, 34, self.RULE_notify)
        self._la = 0 # Token type
        try:
            self.enterOuterAlt(localctx, 1)
            self.state = 183
            self.match(sxlParser.T__11)
            self.state = 184
            localctx.key = self._input.LT(1)
            _la = self._input.LA(1)
            if not((((_la) & ~0x3f) == 0 and ((1 << _la) & ((1 << sxlParser.T__12) | (1 << sxlParser.T__13) | (1 << sxlParser.T__14))) != 0)):
    ...
    def unit_value(self):
        ...
        self.enterRule(localctx, 38, self.RULE_unit_value)
        self._la = 0 # Token type
        try:
            self.enterOuterAlt(localctx, 1)
            self.state = 189
            _la = self._input.LA(1)
            if not((((_la) & ~0x3f) == 0 and ((1 << _la) & ((1 << sxlParser.T__16) | (1 << sxlParser.T__17) | (1 << sxlParser.LABEL))) != 0)):
                self._errHandler.recoverInline(self)
            else:
                self._errHandler.reportMatch(self)
                self.consume()
    ...
    def numrep(self):
        ...
        self.enterRule(localctx, 40, self.RULE_numrep)
        try:
            self.enterOuterAlt(localctx, 1)
            self.state = 191
            self.match(sxlParser.T__18)
            self.state = 192
            self.numrep_value()
        except RecognitionException as re:
            localctx.exception = re
    ...
    def numrep_value(self):
        ...
        self.enterRule(localctx, 42, self.RULE_numrep_value)
        self._la = 0 # Token type
        try:
            self.enterOuterAlt(localctx, 1)
            self.state = 194
            _la = self._input.LA(1)
            if not((((_la) & ~0x3f) == 0 and ((1 << _la) & ((1 << sxlParser.T__19) | (1 << sxlParser.T__20) | (1 << sxlParser.T__21) | (1 << sxlParser.T__22) | (1 << sxlParser.T__23) | (1 << sxlParser.T__24) | (1 << sxlParser.T__25) | (1 << sxlParser.T__26) | (1 << sxlParser.T__27) | (1 << sxlParser.T__28))) != 0)):
                self._errHandler.recoverInline(self)
            else:
                self._errHandler.reportMatch(self)
                self.consume()
    ...
    def range_item(self):
        ...
        self.enterRule(localctx, 44, self.RULE_range_item)
        try:
            self.enterOuterAlt(localctx, 1)
            self.state = 196
    ...
    def range_value(self):
        ...
        self.enterRule(localctx, 46, self.RULE_range_value)
        self._la = 0 # Token type
        try:
            self.enterOuterAlt(localctx, 1)
            self.state = 199
            _la = self._input.LA(1)
            if not((((_la) & ~0x3f) == 0 and ((1 << _la) & ((1 << sxlParser.T__16) | (1 << sxlParser.Fix_range) | (1 << sxlParser.Nat_range) | (1 << sxlParser.Int_range))) != 0)):
                self._errHandler.recoverInline(self)
            else:
                self._errHandler.reportMatch(self)
                self.consume()
    ...
    def position(self):
        ...
        self.enterRule(localctx, 48, self.RULE_position)
        try:
            self.enterOuterAlt(localctx, 1)
            self.state = 201
    ...
    def position_value(self):
        ...
        self.enterRule(localctx, 50, self.RULE_position_value)
        try:
            self.state = 207
            self._errHandler.sync(self)
            token = self._input.LA(1)
    ...
    def sigmode(self):
        ...
        self.enterRule(localctx, 52, self.RULE_sigmode)
        self._la = 0 # Token type
        try:
            self.enterOuterAlt(localctx, 1)
            self.state = 209
            self.match(sxlParser.T__31)
            self.state = 210
            localctx.key = self._input.LT(1)
            _la = self._input.LA(1)
            if not((((_la) & ~0x3f) == 0 and ((1 << _la) & ((1 << sxlParser.T__12) | (1 << sxlParser.T__13) | (1 << sxlParser.T__14) | (1 << sxlParser.T__32) | (1 << sxlParser.T__33))) != 0)):
                localctx.key = self._errHandler.recoverInline(self)
            else:
                self._errHandler.reportMatch(self)
                self.consume()
    ...
    def resetval(self):
        ...
        self.enterRule(localctx, 54, self.RULE_resetval)
        try:
            self.enterOuterAlt(localctx, 1)
            self.state = 212
    ...
    def resetval_value(self):
        ...
        self.enterRule(localctx, 56, self.RULE_resetval_value)
        try:
            self.state = 218
            self._errHandler.sync(self)
            token = self._input.LA(1)
    ...
    def type_item(self):
        ...
        self.enterRule(localctx, 58, self.RULE_type_item)
        try:
            self.enterOuterAlt(localctx, 1)
            self.state = 220
            self.match(sxlParser.T__35)
            self.state = 221
            self.type_val()
        except RecognitionException as re:
            localctx.exception = re
    ...
    def type_val(self):
        ...
        self.enterRule(localctx, 60, self.RULE_type_val)
        self._la = 0 # Token type
        try:
            self.enterOuterAlt(localctx, 1)
            self.state = 223
            _la = self._input.LA(1)
            if not(_la==sxlParser.T__26 or _la==sxlParser.T__36):
                self._errHandler.recoverInline(self)
            else:
                self._errHandler.reportMatch(self)
                self.consume()
